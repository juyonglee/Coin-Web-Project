...
router.post('/signup', function(req, res, next) {
    crypto.randomBytes(64, (err, buf) => {
        ...
        Account.create({ username : req.body.username, salt:buf.toString('base64'), phone: req.body.phoneNumber, password: derivedKey.toString('base64'), name: req.body.name, FNB: 0}).then(
            function() {
                console.log("저장");
